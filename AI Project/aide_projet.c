...
void appliquer_transformation_base(uint8_t grille[9], transformation t);
void print_grille_2d(uint8_t grille[9], FILE *f);
...
void print_all_transformations_2d(uint8_t g[9], FILE *f)
{
    print_grille_2d(g,f);
    fprintf(f, "|");
...
int main() {
    ...
    print_all_transformations_2d(g, out);
